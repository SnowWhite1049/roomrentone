        ...
        <div id="slider" class="inspiro-slider slider-fullscreen dots-creative" data-fade="true">
            <!-- Slide 1 -->
            <div class="slide kenburns" data-bg-video="<?php echo get_template_directory_uri(); ?>/assets/video/pexels-man-walking.mp4">
            ...
            <!-- end: Slide 1 -->
            <!-- Slide 2 -->
            <div class="slide" data-bg-video="<?php echo get_template_directory_uri(); ?>/assets/video/waves.mp4">
                <div class="bg-overlay"></div>
                <div class="container">
                    <div class="slide-captions text-center text-light">
                        <!-- Captions -->
        ...
        <section id="welcome" class="p-b-0">
            <div class="container">
                ...
                <div class="row" data-animate="fadeInUp">
                    <div class="col-lg-12">
                    サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介
                    サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介サービス紹介
                    </div>
                </div>
            </div>
        </section>
